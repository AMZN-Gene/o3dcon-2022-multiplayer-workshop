...
namespace MyMultiplayerGame
{
    ...
    {
    public:
        AZ_MULTIPLAYER_COMPONENT(MyMultiplayerGame::NetworkWeaponsComponent, s_networkWeaponsComponentConcreteUuid, MyMultiplayerGame::NetworkWeaponsComponentBase);

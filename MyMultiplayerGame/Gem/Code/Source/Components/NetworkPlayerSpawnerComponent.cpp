...
namespace MyMultiplayerGame
{
    ...
    {
        AZ::Interface<MyMultiplayerGame::IPlayerSpawner>::Get()->RegisterPlayerSpawner(this);
    }

    void NetworkPlayerSpawnerComponent::OnDeactivate([[maybe_unused]] Multiplayer::EntityIsMigrating entityIsMigrating)
    {
        AZ::Interface<MyMultiplayerGame::IPlayerSpawner>::Get()->UnregisterPlayerSpawner(this);
    }
} // namespace MyMultiplayerGame

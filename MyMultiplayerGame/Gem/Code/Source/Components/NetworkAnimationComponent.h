...
namespace MyMultiplayerGame
{
    ...
    {
    public:
        AZ_MULTIPLAYER_COMPONENT(MyMultiplayerGame::NetworkAnimationComponent, s_networkAnimationComponentConcreteUuid, MyMultiplayerGame::NetworkAnimationComponentBase);

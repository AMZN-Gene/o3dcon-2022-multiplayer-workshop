...
namespace MyMultiplayerGame
{
    ...
    void ReflectWeaponEnums(AZ::ReflectContext* context)
    {
        ...
        if (serializeContext)
        {
            ...
            if (editContext)
            {
                editContext->Enum<CharacterAnimState>("CharacterAnimState", "Various MyMultiplayerGame character animation states")
                ...
                editContext->Enum<WeaponType>("WeaponType", "Different weapon types in MyMultiplayerGame")
                    ->Value("None", WeaponType::None)
                    ->Value("Trace", WeaponType::Trace)
                    ->Value("Projectile", WeaponType::Projectile);

                editContext->Enum<WeaponStatus>("WeaponStatus", "Status states for a MyMultiplayerGame weapon")
